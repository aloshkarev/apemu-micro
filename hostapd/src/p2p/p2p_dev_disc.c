...
int p2p_send_dev_disc_req(struct p2p_data *p2p, struct p2p_device *dev) {
    ...
    p2p_dbg(p2p, "Sending Device Discoverability Request to GO "
                 MACSTR
                 " for client "
                 MACSTR,
...
static void p2p_send_dev_disc_resp(struct p2p_data *p2p, u8 dialog_token,
    ...
    p2p_dbg(p2p, "Sending Device Discoverability Response to "
                 MACSTR
                 " (status %u freq %d)",
...
void p2p_process_dev_disc_req(struct p2p_data *p2p, const u8 *sa,
    ...
    p2p_dbg(p2p, "Received Device Discoverability Request from "
                 MACSTR
...
void p2p_process_dev_disc_resp(struct p2p_data *p2p, const u8 *sa,
    ...
    p2p_dbg(p2p, "Received Device Discoverability Response from "
                 MACSTR,
            MAC2STR(sa));
