...
static int p2p_parse_attribute(u8 id, const u8 *data, u16 len,
    ...
    switch (id) {
        ...
        case P2P_ATTR_DEVICE_ID:
            ...
            msg->device_id = data;
            wpa_printf(MSG_DEBUG, "P2P: * Device ID "
                                  MACSTR,
        ...
        case P2P_ATTR_DEVICE_INFO:
            ...
            wpa_printf(MSG_DEBUG, "P2P: * Device Info: addr "
                                  MACSTR
        ...
        case P2P_ATTR_GROUP_BSSID:
            ...
            wpa_printf(MSG_DEBUG, "P2P: * P2P Group BSSID: "
                                  MACSTR,
        ...
        case P2P_ATTR_SESSION_ID:
            ...
            wpa_printf(MSG_DEBUG, "P2P: * Session ID: %x "
                                  MACSTR,
        ...
        case P2P_ATTR_PERSISTENT_GROUP: {
            ...
            wpa_printf(MSG_DEBUG, "P2P: * Persistent Group: "
                                  MACSTR
                                  " %s",
...
int p2p_attr_text(struct wpabuf *data, char *buf, char *end) {
    ...
    if (msg.p2p_device_addr) {
        ret = os_snprintf(pos, end - pos, "p2p_device_addr="
                                          MACSTR
                                          "\n",
                          MAC2STR(msg.p2p_device_addr));
        if (os_snprintf_error(end - pos, ret))
